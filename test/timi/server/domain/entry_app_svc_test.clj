(ns timi.server.domain.entry-app-svc-test
  (:require
    ...
    [timi.server.domain.entry-app-svc :as svc]
    [timi.server.infra.date-time :refer [->local-time
                                         ->local-date
                                         today
                                         date-equal?
                                         time-equal?]]
    [timi.server.test-helpers :refer [copy-tests deftest]]))
